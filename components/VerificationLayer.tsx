...
const VerificationLayer: React.FC = () => {
  return (
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-64px)] w-full overflow-hidden rounded-[2rem] border border-slate-800 shadow-2xl animate-in fade-in zoom-in-95 duration-700">
      ...
      {/* Left Panel: Researcher / Scientist (Moved to Priority Position) */}
      <section className="flex-1 p-8 md:p-16 flex flex-col justify-between bg-gradient-to-br from-slate-950 to-emerald-950/20 relative group overflow-hidden border-r border-slate-800">
      ...
      {/* Right Panel: Strategic / Investor */}
      <section className="flex-1 p-8 md:p-16 flex flex-col justify-between bg-gradient-to-br from-slate-900 to-black relative group overflow-hidden">
